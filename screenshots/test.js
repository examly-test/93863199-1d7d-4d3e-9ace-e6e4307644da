...
(async () => {
  ...
  await page.goto('https://8080-dcdbdadacceceffebabeadbabfbdddaecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-dcdbdadacceceffebabeadbabfbdddaecdcaceefaffcabd.ide.exam.ly');
