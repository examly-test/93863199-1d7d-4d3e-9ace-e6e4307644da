...
(async () => {
  ...
  await page.goto('https://8080-dcdbdadacceceffebabeadbabfbdddaebebbcafb.ide.exam.ly');
  ...
  await page1.goto('https://8081-dcdbdadacceceffebabeadbabfbdddaebebbcafb.ide.exam.ly');
